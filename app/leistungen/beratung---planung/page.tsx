    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-800 via-gray-700 to-oxford-blue">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-96">
              <Image
                src="/images/beratung-professional.png"
                alt="Professionelle Beratung und Planung"
                fill
      ...
      <section className="py-16 px-6 bg-black/20">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-8">
            {[
              { step: "1", title: "Erstbegehung & Bedarfsanalyse", description: "Kostenlose Begehung vor Ort und umfassende Bedarfsanalyse" },
              { step: "2", title: "Projektplanung & Konzept", description: "Detaillierte Planung und Entwicklung eines Gesamtkonzepts" },
              { step: "3", title: "Genehmigungen & Koordination", description: "Behördliche Genehmigungen und Koordination aller Beteiligten" },
              { step: "4", title: "Angebot & Umsetzung", description: "Transparentes Festpreisangebot und professionelle Umsetzung" }
            ].map((step, index) => (
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-4xl font-bold text-white mb-6">Benötigen Sie professionelle Beratung?</h2>
