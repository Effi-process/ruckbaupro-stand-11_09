          ...
          <div className="flex justify-center px-4 sm:px-6">
            ...
            {[
              { 
                ...
                details: "Identifikation durch Laboranalyse. Bestimmung der Gefährdungsklasse nach TRGS 521.",
                icon: (
              ...
              { 
                ...
                details: "Anlegen der Vollschutzausrüstung. Einrichtung von Absauganlagen.",
                icon: (
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              { 
                ...
                details: "Demontage durch Nassabbau-Verfahren. Direkte Absaugung an der Entstehungsstelle.",
                icon: (
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              { 
                ...
                details: "Luftüberwachung mit Partikelmessgeräten. Fachgerechte Verpackung und Entsorgung.",
                icon: (
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
