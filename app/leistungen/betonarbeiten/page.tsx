          ...
          <div className="flex justify-center px-4 sm:px-6">
            ...
            {[
              { 
                ...
                details: "Bewertung der Betonstruktur durch Bauingenieure. Ermittlung der Bewehrungslage mit Scanner.",
                icon: (
              ...
              { 
                ...
                details: "Auswahl der passenden Diamantwerkzeuge. Kalibrierung für millimetergenaue Arbeiten.",
                icon: (
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              { 
                ...
                details: "Millimetergenaue Schnitte und Bohrungen. Wassergespülte Arbeitsweise verhindert Staub.",
                icon: (
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              { 
                ...
                details: "Glätten aller Schnittflächen. Entfernung von Bohrmehl und Kontrolle der Qualität.",
                icon: (
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
