...
export default function ProcessFlow() {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-b from-gray-700 via-gray-800 to-oxford-blue relative overflow-hidden">
      {/* Background Elements */}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {steps.map((step, index) => (
            <div key={index} className="group relative">
              ...
              {/* Step Card */}
              <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl sm:rounded-3xl p-3 sm:p-4 lg:p-6 text-center hover:bg-white/10 hover:border-cerulean/50 transition-all duration-500 transform hover:-translate-y-2 hover:shadow-2xl hover:shadow-cerulean/20 group h-full flex flex-col overflow-hidden">
                {/* Glow Effect */}
                ...
                <div className="relative z-10 flex-1 flex flex-col justify-between">
                  <h3 className="text-sm sm:text-base lg:text-xl font-black text-white mb-1 sm:mb-2 group-hover:text-cerulean transition-colors duration-300 tracking-wide">
                    {step.title}
                  </h3>
                  <p className="text-cerulean/90 font-bold text-[9px] sm:text-[10px] md:text-xs tracking-wider mb-1 sm:mb-2 uppercase line-clamp-2">
                    {step.description}
                  </p>
                  <p className="text-white/70 group-hover:text-white/90 leading-relaxed text-[10px] sm:text-[11px] md:text-xs transition-colors duration-300 line-clamp-3">
                    {step.details}
                  </p>
                </div>
