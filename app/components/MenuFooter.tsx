                ...
                <div>
                  ...
                  {section.button && (
                    <Link
                      ...
                      className="block w-full sm:w-auto sm:inline-block bg-cerulean hover:bg-indigo-dye text-white px-4 py-3 rounded-lg font-semibold transition-colors text-center"
                    >
                      {section.button.text}
                    </Link>
                  )}
