        ...
        <div className="px-[5vw] pt-32 pb-24">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-12 text-white/90">
              ...
              <section className="bg-gradient-to-r from-green-900/20 to-emerald-900/20 backdrop-blur-md rounded-xl p-6 border border-green-400/30">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <p className="text-white/80 text-sm mb-1">Versicherer</p>
                    <p className="text-white font-semibold">Allianz Versicherungs-AG</p>
                    <p className="text-white/60 text-sm">Königinstraße 28, 80802 München</p>
                  </div>
                  <div>
                    <p className="text-white/80 text-sm mb-1">Deckung</p>
                    <p className="text-green-400 font-bold text-xl">10.000.000 EUR</p>
                    <p className="text-white/60 text-sm">Geltungsraum: Deutschland</p>
                  </div>
                </div>
              </section>
