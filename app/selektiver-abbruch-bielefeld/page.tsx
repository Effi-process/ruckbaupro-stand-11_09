      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none text-white">
            ...
            <h2 className="text-3xl font-bold text-white mb-8 mt-12">
              Teilabbruch
            </h2>
            ...
            <div className="bg-gradient-to-r from-sky-900/30 to-slate-800/30 backdrop-blur-xl border-l-4 border-sky-400 p-6 my-8 rounded-lg">
          ...
          {/* Service Areas */}
          <div className="mt-12 p-8 bg-gradient-to-r from-sky-900/30 to-slate-800/30 backdrop-blur-xl rounded-2xl border border-sky-400/20">
            <h2 className="text-2xl font-bold text-white mb-6">Unsere Einsatzgebiete in Bielefeld</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {['Mitte', 'Schildesche', 'Gadderbaum', 'Brackwede', 'Sennestadt', 'Heepen', 'Jöllenbeck', 'Stieghorst', 'Dornberg'].map(area => (
                <div key={area} className="bg-slate-800/50 backdrop-blur px-4 py-2 rounded-lg text-sky-100 text-center border border-sky-400/20">
                  {area}
                </div>
              ))}
            </div>
          ...
          {/* FAQ Section */}
          <div className="mt-16">
            <h2 className="text-3xl font-bold text-white mb-8">Häufige Fragen zum selektiven Abbruch</h2>

            <div className="space-y-6">
              <div className="bg-gradient-to-r from-sky-900/30 to-slate-800/30 backdrop-blur-xl p-6 rounded-xl border border-sky-400/20">
                <h3 className="text-xl font-semibold text-sky-200 mb-3">Was kostet ein selektiver Abbruch?</h3>
              ...
              <div className="bg-gradient-to-r from-sky-900/30 to-slate-800/30 backdrop-blur-xl p-6 rounded-xl border border-sky-400/20">
                <h3 className="text-xl font-semibold text-sky-200 mb-3">Brauche ich eine Genehmigung?</h3>
                <p className="text-white/70">
              ...
              <div className="bg-gradient-to-r from-sky-900/30 to-slate-800/30 backdrop-blur-xl p-6 rounded-xl border border-sky-400/20">
                <h3 className="text-xl font-semibold text-sky-200 mb-3">Wie lange dauert ein Teilabbruch?</h3>
                <p className="text-white/70">
              ...
              <div className="bg-gradient-to-r from-sky-900/30 to-slate-800/30 backdrop-blur-xl p-6 rounded-xl border border-sky-400/20">
                <h3 className="text-xl font-semibold text-sky-200 mb-3">Muss ich während dem Abbruch ausziehen?</h3>
                <p className="text-white/70">
          ...
          {/* Process Section */}
          <div className="mt-16">
            <h2 className="text-3xl font-bold text-white mb-8">So läuft Ihr selektiver Abbruch ab</h2>

            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-12 h-12 bg-gradient-to-r from-sky-600 to-sky-700 text-white rounded-full flex items-center justify-center font-bold text-lg border border-sky-400/30">
                  1
                </div>
                <div className="flex-grow">
                  <h3 className="text-xl font-semibold text-sky-200 mb-2">Kostenlose Besichtigung</h3>
                  <p className="text-white/70">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-grow">
                  <h3 className="text-xl font-semibold text-sky-200 mb-2">Angebot und Planung</h3>
                  <p className="text-white/70">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-grow">
                  <h3 className="text-xl font-semibold text-sky-200 mb-2">Durchführung</h3>
                  <p className="text-white/70">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-grow">
                  <h3 className="text-xl font-semibold text-sky-200 mb-2">Entsorgung und Reinigung</h3>
                  <p className="text-white/70">
          ...
          {/* CTA Section */}
          <div className="mt-16 text-center bg-gradient-to-r from-sky-900/30 to-slate-800/30 backdrop-blur-xl rounded-2xl p-8 text-white border border-sky-400/20">
